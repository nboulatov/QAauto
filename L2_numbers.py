...
# the circle's radius.
radius_of_a_flowerbed = 3.5
pi = 3.141
area_of_a_circle = pi*radius_of_a_flowerbed**2
...
weather_service_temp = 24.8
current_temp = int(weather_service_temp)
print(current_temp)
# ---------------------------------------------------------------------
...
choco_chips = 17
cookies = 5
remainder = choco_chips%cookies
choco_chips_per_cookie = choco_chips//cookies
print(f'Remainder {remainder}')
print(f'Chocos per cookie {choco_chips_per_cookie}')
# ---------------------------------------------------------------------
...
#Python variables cannot start with a number. Variable names can only consist of letters, numbers, underscores, and hyphens, and they must start with a letter or underscore
...
students_age_mean = int((student_1_age + student_2_age + student_3_age) / 3)
