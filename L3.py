...
print(f'"{message}" contains {number_of_chars} characters')
# ---------------------------------------------------------------------
...
transformed_sentence2 = transformed_sentence.replace('e', '*')
transformed_sentence3 = transformed_sentence2.replace('i', '*')
transformed_sentence4 = transformed_sentence3.replace('o', '*')
transformed_sentence5 = transformed_sentence4.replace('u', '*')
print(transformed_sentence5)
# ------------------------------# ---------------------------------------------------------------------
...
mi_to_km = miles * 1.6
print(f'{miles} miles is approximately {mi_to_km} kilometers')
# ---------------------------------------------------------------------
...
cardio = int(input("What is the number # of minutes spent on cardio? "))
strength_training = int(input("What is the number # of minutes spent on strength training? "))
yoga = int(input("What is the number # of minutes spent on yoga? "))
total = cardio+strength_training+yoga
print(f"Total time spent exercising is {total} minutes. Great Job! Keep up the good work")
# ---------------------------------------------------------------------
# Challenge 1 (OPTIONAL!): Reverse the negative integer -324 and keep
# the negative symbol. Expected output: -423
input_number = -324
convert_to_str = str(input_number)
str_with_out_negative = convert_to_str[1:]
negative = convert_to_str[0]
reverse = str_with_out_negative[::-1]
print(f'{negative}{reverse}')
# ---------------------------------------------------------------------
